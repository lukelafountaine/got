...
ava_1.default('hostname + pathname are not breaking redirects', with_server_1.default, async (t, server, got) => {
    server.get('/', reachedHandler);
    server.get('/relative', relativeHandler);
...
ava_1.default('method overwriting can be turned off', with_server_1.default, async (t, server, got) => {
    server.post('/redirect', (_request, response) => {
        response.writeHead(302, {
            location: '/'
        });
