...
ava_1.default.skip('clear the progressInterval if the socket has been destroyed', async (t) => {
    ...
    await t.throwsAsync(source_1.default('http://127.0.0.1:55555', { retry: 0 }), {
        code: 'ECONNREFUSED'
    });
